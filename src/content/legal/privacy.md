...
마니(서비스명: ㅇㄱㄱ, 이하 "회사")는 다음의 목적을 위하여 개인정보를 처리합니다.
...
- 파기 절차: 불필요한 정보는 내부 방침에 따라 즉시 파기
- 파기 방법: 전자적 파일 형태는 복구 불가능한 방법으로 삭제
...
|---------|------------|
| AWS | 데이터 저장 및 서버 관리 |
| Google | AI 분석 (Gemini Vision API) |
...
- 물리적 조치: 클라우드 인프라(AWS) 접근통제 및 권한 관리
